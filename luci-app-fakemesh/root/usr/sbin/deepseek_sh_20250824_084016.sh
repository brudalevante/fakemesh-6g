...
EOF
	...
	for band in 5g 6g; do
		...
		if test -n "$wbandstr"; then
			...
			if [ "$fronthaul_disabled" = "1" ]; then
				uci set wireless.$meshif.disabled='1'
			else
	...
	if test -n "$wbandstr"; then
		...
		uci set wireless.meshx1_sta.disabled='1'
	fi
	...
	if test -n "$wbandstr"; then
		...
		uci set wireless.meshx2_sta.disabled='1'
	fi
	...
	if test -n "$wbandstr"; then
		...
		uci set wireless.meshx0_sta.disabled='1'
	fi
	...
	if test -n "$wbandstr"; then
		...
		if [ "$fronthaul_disabled" = "1" ]; then
			uci set wireless.meshx2.disabled='1'
		else
